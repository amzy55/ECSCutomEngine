...
public:
    ...
    Shader(
        FileIO::Directory directory, const std::string& vertexFilename, const std::string& geometryFilename,
...
private:
    ...
    static std::string GetPath(
        FileIO::Directory, const std::string& vertexFilename, const std::string& geometryFilename,
        const std::string& fragmentFilename);
